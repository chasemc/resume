...
```{r}
posters <- read.delim(here::here("data/poster_presentations.csv"),sep = "\t")

detailed_entries(data = posters[order(as.Date(posters$year), decreasing = T),], what = title, when = year, with =location , where = meeting)
